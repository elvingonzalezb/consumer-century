                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="single-posts col-lg-6 col-sm-6">
                                        <img class="img-fluid" src="assets/frontend/img/asset/p1.jpg" alt="">
                                        <div class="date mt-20 mb-20">10 Jan 2018</div>
                                        <a href="#"><h4 class="text-uppercase">It S Hurricane Season Visiting </h4></a>
                                    </div>
                                    <div class="single-posts col-lg-6 col-sm-6">
                                        <img class="img-fluid" src="assets/frontend/img/asset/p2.jpg" alt="">
                                        <div class="date mt-20 mb-20">10 Jan 2018</div>
                        ...
                        <div class="post-lists">
                            <div class="single-list flex-row d-flex">
                                <div class="thumb">
                                    ...
                                    <img src="assets/frontend/img/asset/l1.jpg" alt="">
                                </div>
                                <div class="detail">
                            ...
                            <div class="single-list flex-row d-flex">
                                <div class="thumb">
                                    ...
                                    <img src="assets/frontend/img/asset/l2.jpg" alt="">
                                </div>
                                <div class="detail">
                                    <a href="#"><h4 class="pb-20">Addiction When Gambling <br>
                                    Becomes A Problem</h4></a>
                            ...
                            <div class="single-list flex-row d-flex">
                                <div class="thumb">
                                    ...
                                    <img src="assets/frontend/img/asset/l3.jpg" alt="">
                                </div>
                                <div class="detail">
                                    <a href="#"><h4 class="pb-20">Addiction When Gambling <br>
                                    Becomes A Problem</h4></a>
                            ...
                            <div class="single-list flex-row d-flex">
                                <div class="thumb">
                                    ...
                                    <img src="assets/frontend/img/asset/l4.jpg" alt="">
                                </div>
                                <div class="detail">
                                    <a href="#"><h4 class="pb-20">Addiction When Gambling <br>
                                    Becomes A Problem</h4></a>
