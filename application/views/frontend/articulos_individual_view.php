                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="single-page-post">
                            ...
                            foreach($articulos as $ultimo)
                            {
                                ...
                                echo'<h2 class="col-lg-8 col-md-12 text-uppercase">'.$ultimo->titulo.'</h2>';
                                echo'<div class="col-lg-4 col-md-12 right-side d-flex justify-content-end">';
                                echo'<div class="desc">';
                                echo'<h2>Mark wiens</h2>';
                                echo'<h3>'.$ultimo->created.'</h3>';
                                echo'</div>';
                                echo'<div class="user-img">';
                                echo'<img src="assets/frontend/img/user.jpg" alt="">';
                                echo'</div>';
                                echo'</div>';
                                echo'</div>';
                                echo'</div>';
                                ...
                                <div class="container">
                                    <div class="row justify-content-between">
                                        <div class="col-sm-6 nav-left justify-content-start d-flex">
                                            <div class="thumb">
                                                <img src="assets/frontend/img/prev.jpg" alt="">
                                            </div>
                                            <div class="details">
                                                <p>Prev Post</p>
                                        ...
                                        <div class="col-sm-6 nav-right justify-content-end d-flex">
                                            ...
                                            <div class="thumb">
                                                <img src="assets/frontend/img/next.jpg" alt="">
                                            </div>                         
                                        </div>
                                    </div>
                                </div>    
                                    ...
                                    <div class="row flex-column">
                                        ...
                                        <div class="comment-list">
                                            <div class="single-comment justify-content-between d-flex">
                                                <div class="user justify-content-between d-flex">
                                                    <div class="thumb">
                                                        <img src="assets/frontend/img/asset/c1.jpg" alt="">
                                                    </div>
                                                    <div class="desc">
                                        ...
                                        <div class="comment-list left-padding">
                                            <div class="single-comment justify-content-between d-flex">
                                                <div class="user justify-content-between d-flex">
                                                    <div class="thumb">
                                                        <img src="assets/frontend/img/asset/c2.jpg" alt="">
                                                    </div>
                                                    <div class="desc">
                                                        <h5><a href="#">Emilly Blunt</a></h5>
                                                        <p class="date">December 4, 2017 at 3:12 pm </p>
                                        ...
                                        <div class="comment-list left-padding">
                                            <div class="single-comment justify-content-between d-flex">
                                                <div class="user justify-content-between d-flex">
                                                    <div class="thumb">
                                                        <img src="assets/frontend/img/asset/c3.jpg" alt="">
                                                    </div>
                                                    <div class="desc">
                                                        <h5><a href="#">Emilly Blunt</a></h5>
                                                        <p class="date">December 4, 2017 at 3:12 pm </p>
                                        ...
                                        <div class="comment-list">
                                            <div class="single-comment justify-content-between d-flex">
                                                <div class="user justify-content-between d-flex">
                                                    <div class="thumb">
                                                        <img src="assets/frontend/img/asset/c4.jpg" alt="">
                                                    </div>
                                                    <div class="desc">
                                                        <h5><a href="#">Emilly Blunt</a></h5>
                                                        <p class="date">December 4, 2017 at 3:12 pm </p>
                                        ...
                                        <div class="comment-list">
                                            <div class="single-comment justify-content-between d-flex">
                                                <div class="user justify-content-between d-flex">
                                                    <div class="thumb">
                                                        <img src="assets/frontend/img/asset/c5.jpg" alt="">
                                                    </div>
                                                    <div class="desc">
                                                        <h5><a href="#">Emilly Blunt</a></h5>
                                                        <p class="date">December 4, 2017 at 3:12 pm </p>
                    ...
                    <div class="col-lg-4 sidebar-area ">
                        ...
                        <div class="single_widget about_widget">
                            <img src="assets/frontend/img/asset/s-img.jpg" alt="">
                        ...
                        <div class="single_widget recent_widget">
                            ...
                            <div class="active-recent-carusel">
                                <div class="item">
                                    <img src="assets/frontend/img/asset/slider.jpg" alt="">
