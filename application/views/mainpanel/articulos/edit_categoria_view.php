...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="mainpanel/articulos/actualizarCategoria" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="control-group">
                        <div class="controls">
                            ...
                            <p><strong>La imagen a subir debe tener dimensiones de 1000 x 500 pixeles. Caso contrario la imagen se forzará al tamaño indicado.</strong></p>
                            </div> 
                        </div>
                    </div>   
                    <div class="control-group">
                    ...
                    <div class="form-actions">
                        ...
                        <a class="btn btn-danger" href="mainpanel/articulos/categorias">VOLVER AL LISTADO</a>
                    </div>
                </fieldset>
            </form>   
        </div>
