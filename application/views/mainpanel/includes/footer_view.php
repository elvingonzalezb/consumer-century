	...
	<footer>
                <p class="pull-left">&copy; Copyright <?php echo date('Y') ?>. Todos los derechos reservados</p>

		<p class="pull-right">Desarrollado por: <a href="http://www.ajaxperu.com">AJAXPERU</a></p>
...
<!-- external javascript
	...
	<script src="assets/mainpanel/charisma/js/bootbox.js"></script>
	...
	<script src="assets/mainpanel/charisma/js/js_color_picker/color_functions.js"></script>		
    <script src="assets/mainpanel/charisma/js/js_color_picker/js_color_picker_v2.js"></script>
    
    <script type="text/javascript" src="assets/mainpanel/charisma/js/JSCal2/js/jscal2.js"></script>
    <script type="text/javascript" src="assets/mainpanel/charisma/js/JSCal2/js/lang/es.js"></script>
    ...
    <?php
    	if( ($current_section=="bannersclientes") || ($current_section=="convenios") || ($current_section=="instituciones") || ($current_section=="test") )
    	{
    ?>
