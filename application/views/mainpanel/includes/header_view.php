...
<head media="print">
	...
	<![endif]-->
	<!-- The fav icon -->
    <!--<script type="text/javascript" src="assets/mainpanel/fckeditor/fckeditor.js"></script>-->
    <script src="assets/mainpanel/ckeditor/ckeditor.js"></script>

    <link rel="stylesheet" href="assets/mainpanel/fastselect/dist/fastselect.min.css">
    <script src="assets/mainpanel/fastselect/dist/fastselect.standalone.js"></script>
