...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="mainpanel/servicios/actualizarTexto/<?php echo $generales->seccion;?>" method="post" enctype="multipart/form-data" onsubmit="return validar_articulo()">
                <fieldset>
                    ...
                    <?php 
                       if($this->session->userdata('success'))
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="span6"><img src="files/textosweb/<?php echo $generales->imagen; ?>" width="300" /></div>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="controls">
                        ...
                        <div class="form-actions">
                         ...
                         <a class="btn btn-danger" href="mainpanel/servicios/listado">VOLVER AL LISTADO</a>
                        </div>
                </fieldset>
            </form>
        </div>
