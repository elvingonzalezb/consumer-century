...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="mainpanel/galeria/actualizarTexto/<?php echo $generales->seccion;?>" method="post" enctype="multipart/form-data" onsubmit="return validar_articulo()">
                <fieldset>
                    ...
                    <?php 
                       if($this->session->userdata('success'))
                        ...
                        <div class="form-actions">
                         ...
                         <a class="btn btn-danger" href="mainpanel/galeria/listado">VOLVER AL LISTADO</a>
                        </div>
                </fieldset>
            </form>
        </div>
